export var name = "d3";
export var version = "4.0.0-alpha.35";
export var publishConfig = {"tag":"next"};
export var description = "Data-Driven Documents";
export var keywords = ["dom","visualization","svg","animation","canvas"];
export var homepage = "https://github.com/mbostock/d3";
...
export var repository = {"type":"git","url":"https://github.com/mbostock/d3.git"};
